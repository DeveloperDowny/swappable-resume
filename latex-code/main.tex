...
\newcommand{\resumeType}{nomura} % Options: fs, back, front, sde, fs-front, hox, hox-work, nomura 
...
\IfStrEqCase{\resumeType}{%
	{nomura}{
			\input{components/creating-for/sections/skills}
			\input{components/creating-for/sections/experience}
			\input{components/creating-for/sections/projects}
		}
}[
	\input{components/creating-for/sections/experience}
	\input{components/creating-for/sections/experience}
